...
BOARD_SECTORS: dict[tuple[str, str], list[str]] = {
    ...
    ("greenhouse", "spacex"): ["aerospace", "software"],
    ...
    ("greenhouse", "doordash"): ["software"],
    ("greenhouse", "shopify"): ["software", "retail"],
    ("greenhouse", "hubspot"): ["software", "marketing"],
    ("greenhouse", "snap"): ["software", "media"],
    ("greenhouse", "rivian"): ["automotive", "software"],
    ("greenhouse", "lucidmotors"): ["automotive", "software"],
    ("greenhouse", "twitch"): ["software", "media"],
    ("greenhouse", "unity3d"): ["gaming", "software"],
    ("greenhouse", "samsara"): ["software"],
    ("greenhouse", "canva"): ["software", "design"],
    ("greenhouse", "janestreet"): ["software", "finance"],
    ("greenhouse", "neuralink"): ["science", "software"],
    ("greenhouse", "figureai"): ["software"],
    ("greenhouse", "aurorainnovation"): ["automotive", "software"],
    ("greenhouse", "zyngacareers"): ["gaming", "software"],
    ("greenhouse", "wildlifestudios"): ["gaming", "software"],
    ("greenhouse", "daybreakgames"): ["gaming", "software"],
    ("greenhouse", "voxmedia"): ["media"],
    ("lever", "atlassian"): ["software"],
    ("lever", "eventbrite"): ["software"],
    ("greenhouse", "jumptrading"): ["software", "finance"],
    ("greenhouse", "point72"): ["software", "finance"],
    ("greenhouse", "imc"): ["software", "finance"],
    ("ashby", "nubank"): ["software", "finance"],
    ("greenhouse", "xai"): ["software"],
    ("greenhouse", "canonical"): ["software"],
    ("ashby", "cohere"): ["software"],
    ("ashby", "redis"): ["software"],
    ("smartrecruiters", "Equinox"): ["fitness"],
    ("smartrecruiters", "Continental"): ["automotive", "manufacturing"],
    ("smartrecruiters", "Primark"): ["retail"],
}
